...
const Home = () => {
  return (
    <div id="home" className="section">
      <div className="container bg-bg1 bg-cover bg-no-repeat h-screen w-screen flex place-content-center  ">
        <div className=" mt-36   h-96 w-5/6 flex   ">
          <div className="   h-96 w-5/12">
            <div className="mt-6 text-white text-4xl font-normal">Namasté,</div>
