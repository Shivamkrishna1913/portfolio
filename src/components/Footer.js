        ...
        <div className="flex justify-evenly">
          <div className="rounded-full   w-fit">
            <a
              ...
              target="_blank"
            >
              <img src={linkedin} alt="link" className="w-10" />
            </a>
          </div>
          <div className="rounded-full   w-fit">
            <a
              ...
              target="_blank"
            >
              <img src={youtube} alt="link" className="w-10" />{" "}
            </a>
          </div>
          <div className="rounded-full bg-black w-fit">
            <a href="https://twitter.com/shiv_mmaurya" target="_blank">
              <img src={twitter} alt="link" className="w-10" />{" "}
            </a>
          </div>
        </div>
      </div>
